...
@section('content')
    <div class="d-flex justify-content-between">
        ...
        <div class="">
            <a href="{{ route('students.index') }}" class="btn btn-warning text-white">
                ...
                <div class="card-body">
                    ...
                    <div class="px-5 mb-5">
                        <p class="text-center text-dark ">
                            ...
                            Dolor Sit Amet Ipsum Dolor Sit Amet Lorem Ipsum Lorem Ipsum Dolor Sit Amet Ipsum Dolor Sit Amet
                            Lorem Ipsum
                        </p>
                    </div>
                </div>
