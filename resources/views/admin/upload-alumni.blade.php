                ...
                <table class="table">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>
                                <img src="{{ asset('1.png') }}" width="150px" height="150px" style="object-fit: cover"
                                    alt="" srcset="">
                            </td>
                            <td>
                                <div class="d-flex justify-content-header gap-3">
                                    ...
                                    <div class="">
                                        <button class="btn btn-danger btn-sm">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18"
                                                viewBox="0 0 34 34" fill="none">
                                                <path d="M13.459 20.5417L13.459 16.2917" stroke="white" stroke-width="3"
                                                    stroke-linecap="round" />
                                                <path d="M20.541 20.5417L20.541 16.2917" stroke="white" stroke-width="3"
                                                    stroke-linecap="round" />
                                                <path
