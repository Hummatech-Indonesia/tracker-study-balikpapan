                ...
                <table class="table">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>
                                Seorang Mahasiswa Ub Sedang Menge...
                            </td>
                            <td>
                                01 januari 2006
                            </td>
                            <td>
                                <img src="{{ asset('1.png') }}" width="150px" height="150px" style="object-fit: cover" alt="" srcset="">
                            </td>
                            <td>
                                <div class="d-flex justify-content-header gap-3">
                                    ...
                                    <div class="">
                                        <button class="btn btn-danger btn-sm">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 34 34" fill="none">
                                                <path d="M13.459 20.5417L13.459 16.2917" stroke="white" stroke-width="3" stroke-linecap="round"/>
                                                <path d="M20.541 20.5417L20.541 16.2917" stroke="white" stroke-width="3" stroke-linecap="round"/>
                                                <path d="M4.25 9.20825H29.75V9.20825C27.7603 9.20825 26.7655 9.20825 26.0509 9.68575C25.7415 9.89247 25.4759 10.1581 25.2692 10.4675C24.7917 11.1821 24.7917 12.1769 24.7917 14.1666V21.9583C24.7917 24.6295 24.7917 25.9652 23.9618 26.7951C23.1319 27.6249 21.7963 27.6249 19.125 27.6249H14.875C12.2037 27.6249 10.8681 27.6249 10.0382 26.7951C9.20833 25.9652 9.20833 24.6295 9.20833 21.9583V14.1666C9.20833 12.1769 9.20833 11.1821 8.73083 10.4675C8.52411 10.1581 8.25849 9.89247 7.94912 9.68575C7.23448 9.20825 6.23965 9.20825 4.25 9.20825V9.20825Z" stroke="white" stroke-width="3" stroke-linecap="round"/>
                                                <path d="M13.4577 4.95876C13.4577 4.95876 14.166 3.54175 16.9993 3.54175C19.8327 3.54175 20.541 4.95841 20.541 4.95841" stroke="white" stroke-width="3" stroke-linecap="round"/>
                                              </svg>
                                        </button>
                                    </div>
                                </div>
