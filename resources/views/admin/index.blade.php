            ...
            <div class="card radius-10 border-start border-0 border-4 border-primary">
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        ...
                        <div class="widgets-icons-2 rounded-circle text-white ms-auto" style="background-color: #ECF2FF;"><svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 44 44" fill="none">
            ...
            <div class="card radius-10 border-start border-0 border-4" style="border-color: #8D441C !important;">
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        ...
                        <div class="widgets-icons-2 rounded-circle text-white ms-auto" style="background-color: #FFEDE3;"><svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 44 44" fill="none">
                            <path d="M24.75 22C29.2867 22 33.2948 17.728 33.6875 12.4764C33.8826 9.83812 33.055 7.37773 31.3569 5.54984C29.6768 3.7443 27.3281 2.75 24.75 2.75C22.1513 2.75 19.8009 3.73828 18.1328 5.53266C16.4459 7.3468 15.6235 9.81234 15.8125 12.4747C16.1984 17.7272 20.2056 22 24.75 22Z" fill="#8D441C"/>
                            <path d="M42.5718 37.7919C41.8465 33.7683 39.582 30.3884 36.0242 28.0165C32.8643 25.9102 28.8604 24.75 24.75 24.75C20.6397 24.75 16.6358 25.9102 13.4759 28.0156C9.91809 30.3875 7.65364 33.7674 6.92833 37.791C6.76247 38.7131 6.98762 39.6249 7.54622 40.2927C7.79958 40.5969 8.1177 40.8408 8.47736 41.0064C8.83701 41.1721 9.22912 41.2553 9.62505 41.25H39.875C40.2712 41.2556 40.6636 41.1727 41.0236 41.0072C41.3835 40.8417 41.702 40.5979 41.9556 40.2935C42.5125 39.6258 42.7376 38.714 42.5718 37.7919Z" fill="#8D441C"/>
                            <path d="M12.375 18.5625H2.75C2.38533 18.5625 2.03559 18.7074 1.77773 18.9652C1.51987 19.2231 1.375 19.5728 1.375 19.9375C1.375 20.3022 1.51987 20.6519 1.77773 20.9098C2.03559 21.1676 2.38533 21.3125 2.75 21.3125H12.375C12.7397 21.3125 13.0894 21.1676 13.3473 20.9098C13.6051 20.6519 13.75 20.3022 13.75 19.9375C13.75 19.5728 13.6051 19.2231 13.3473 18.9652C13.0894 18.7074 12.7397 18.5625 12.375 18.5625Z" fill="#8D441C"/>
                          </svg>
                        </div>
                    </div>
                </div>
