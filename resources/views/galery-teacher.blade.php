            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <div class="app-screenshots">
                        @forelse ($teachers->chunk(2) as $chunk)
                                    ...
                                    <div class="reviewer-thumb mt-3">
                                        <div class="border-custom"
                                            ...
                                            <img style="object-fit: cover; width: 100%; height: 100%;"
                                                src="{{ asset('storage/' . $teacher->photo) }}" alt="">
                                        </div>
                                        <div class="bg-primary col-9 rounded mt-3">
                        ...
                        <div class="single-screenshot">
                            <div class="single-blog res-margin">
                                ...
                                <div class="blog-content p-4">
                                    <!-- Blog Title -->
                                    <h3 class="blog-title my-3"><a href="#">Alumni Angkatan 2021 - 2023 Berkumpul Di
                                            Sekolah</a></h3>
                                    <p class="blog-btn mt-3">12 Februai 2038</p>
                                    <button class="btn btn-outline-info w-100">Lihat Selengkapnya</button>
                                </div>
                            </div>
                            <div class="single-blog res-margin mt-3">
                                <!-- Blog Thumb -->
                                <div class="blog-thumb">
                                    <a href="#"><img src="{{ asset('1.png') }}" alt=""></a>
                                </div>
                ...
                <div class="row">
                    <div class="col-12 col-sm-6 col-lg-4">
                        ...
                        <div class="footer-items">
                            ...
                            <p class="mt-2 mb-3" style="font-size: 14px">Lorem ipsum dolor sit amet, consectetur
                                adipisicing elit. Quis non, fugit
                                totam vel laboriosam vitae.</p>
                            <!-- Social Icons -->
                            <div class="social-icons d-flex">
                                <div class="" style="margin-right: 1rem">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="36" height="36" fill="#5D87FF"
                    ...
                    <div class="col-12 col-sm-6 col-lg-4">
                        ...
                        <div class="footer-items">
                            <!-- Footer Title -->
                            <h3 class="footer-title mb-2">Alamat</h3>
                            <div class="d-flex">
                                <svg xmlns="http://www.w3.org/2000/svg" width="34" height="34" fill="#5D87FF"
                                    fill="currentColor" class="bi bi-geo-alt-fill" viewBox="0 0 16 16">
                                    <path
                                        d="M8 16s6-5.686 6-10A6 6 0 0 0 2 6c0 4.314 6 10 6 10m0-7a3 3 0 1 1 0-6 3 3 0 0 1 0 6" />
                                </svg>
                                <p style="font-size: 14px;margin-left:1rem;">Jl. Habe, Nenang, Penajam, Kabupaten Penajam
                                    Paser Utara, Kalimantan Timur 76142
                                </p>
                            </div>
                            <div class="d-flex my-3">
                                <svg xmlns="http://www.w3.org/2000/svg" width="19" height="19" fill="#5D87FF"
                                    class="bi bi-envelope-open-fill" viewBox="0 0 16 16">
                                    <path
                                        d="M8.941.435a2 2 0 0 0-1.882 0l-6 3.2A2 2 0 0 0 0 5.4v.314l6.709 3.932L8 8.928l1.291.718L16 5.714V5.4a2 2 0 0 0-1.059-1.765l-6-3.2ZM16 6.873l-5.693 3.337L16 13.372v-6.5Zm-.059 7.611L8 10.072.059 14.484A2 2 0 0 0 2 16h12a2 2 0 0 0 1.941-1.516M0 13.373l5.693-3.163L0 6.873v6.5Z" />
                                </svg>
                                <p style="font-size: 14px;margin-left:1rem;">Admin@smkn2ppu.sch.id
                                </p>
                            </div>
                            <div class="d-flex my-3">
                                <svg xmlns="http://www.w3.org/2000/svg" width="19" height="19" fill="#5D87FF"
                                ...
                                <p style="font-size: 14px;margin-left:1rem; color:#5D87FF">0542-7211392
                                </p>
                            </div>
                        </div>
                    </div>
