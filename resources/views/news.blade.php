        ...
        <div class="row align-items-center">
            ...
            <div class="col-12 col-md-7 col-lg-6">
                <div class="welcome-intro">
                    ...
                    <p class="text-white my-4">"Selamat datang di Halaman Berita kami! Temukan berita terkini seputar prestasi, inovasi, dan peristiwa terbaru dari komunitas kami. Dapatkan informasi relevan dan artikel menarik untuk tetap terhubung dengan perkembangan terkini. Stay informed, stay inspired!"</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-12 col-md-7 col-lg-5">
                <div class="welcome-intro">
                    <h3 class="text-black fs-3 text-center">SMKN 2 Penajam</h3>
                    <p class="text-black my-4">"Selamat datang di Halaman Berita kami! Temukan berita terkini seputar prestasi, inovasi, dan peristiwa terbaru dari komunitas kami. Dapatkan informasi relevan dan artikel menarik untuk tetap terhubung dengan perkembangan terkini. Stay informed, stay inspired!"</p>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="col-12 col-md-4">
                ...
                <div class="single-blog res-margin">
                    ...
                    <div class="blog-content p-4">
                        <p class="blog-btn">12 Februai 2038</p>
                        <!-- Blog Title -->
                        <h5 class="blog-title my-3"><a href="#">Alumni Angkatan  2021 - 2023 Berkumpul Di Sekolah</a></h5>

                        <p style="text-overflow: ellipsis;overflow: hidden ;max-width: 300px ;white-space: nowrap" class="blog">Selamat datang di Galeri Kegiatan Alumni kami! Temukan warisan inspira....</p>
                        <a href="">
