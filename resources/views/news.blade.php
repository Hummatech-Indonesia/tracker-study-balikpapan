            ...
            <div class="col-12 col-md-4">
                ...
                <div class="single-blog res-margin">
                    ...
                    <div class="blog-thumb">
                        <img style="width: 400px; height: 200px; object-fit: cover;" src="{{ asset('storage/' . $new->thumbnail) }}" alt="">

                    </div>
                    <!-- Blog Content -->
                    <div class="blog-content p-4">
                        <p class="blog-btn">{{ Carbon::parse($new->created_at)->locale('id_ID')->isoFormat('DD MMMM Y') }}</p>
                        <!-- Blog Title -->
                        <h5 class="blog-title my-3"><a href="#">{{ $new->title }}</a></h5>

                        <p style="text-overflow: ellipsis;overflow: hidden ;max-width: 300px ;white-space: nowrap" class="blog">{{ $new->content }}</p>
