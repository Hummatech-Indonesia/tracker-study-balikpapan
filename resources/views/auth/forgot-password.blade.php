                        ...
                        <div class="card-body p-sm-5">
                            <div class="">
                                ...
                                <div class="text-center">
                                    ...
                                    <p class="mb-0 text-dark fs-6 mb-2">Inputkan email anda untuk kami kirim verifikasi
                                        untuk reset password</p>
                                </div>
                                <div class="form-body">
                                    <form action="{{ route('send.email.forgot.password') }}" method="POST" class="row g-3">
                                        @csrf
                                        <div class="col-12">
