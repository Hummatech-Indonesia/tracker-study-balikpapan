<div class="sidebar-wrapper" data-simplebar="true">
    ...
    <ul class="metismenu" id="menu">
        ...
        <li class="active">
            <a href="{{ route('dashboard') }}" class="active">
                <div class="parent-icon">
                    <div class="parent-icon"><i class="icon" data-tp-toggle="tooltip" data-tp-placement="left" data-tp-title="Dashboard">
        ...
        <li class="active">
            <a href="#" class="active">
                <div class="parent-icon">
                    <div class="parent-icon"><i class="icon" data-tp-toggle="tooltip" data-tp-placement="left" data-tp-title="analytics">
                        <svg width="26" height="26" class="icon-20" viewBox="0 0 16 16" fill="none"
                    ...
                    <div class="menu-title mt-2">Alumni</div>
            </a>
        </li>
        <li class="active">
            <a href="#" class="active">
                <div class="parent-icon">
                    <div class="parent-icon"><i class="icon" data-tp-toggle="tooltip" data-tp-placement="left" data-tp-title="Crypto">
                        <svg class="icon-24" width="24" height="20" viewBox="0 0 14 14" fill="none"
                            xmlns="http://www.w3.org/2000/svg">
                            <path opacity="0.4"
                    ...
                    <div class="menu-title mt-1">Statistik</div>
            </a>
        </li>
        <li class="active">
            <a href="#" class="active">
