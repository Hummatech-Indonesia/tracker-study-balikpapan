...
<div class="sidebar-header relative flex items-center justify-start mb-3 border-b dark:border-gray-700 z-0">
    <a href="index.html" class="flex px-5 py-4 mr-4 rtl:ml-4 rtl:mr-0 text-xl items-center">
        <!--Logo start-->
        <img class="w-14 h-14 p-1 text-primary-400  rounded-full dark:bg-primary-800 "
            src="{{ asset('assets-admin/images/logoschool.png') }}">
        <!--logo End-->
        <h4 class="sidebar-logo text-base font-semibold" data-setting="app_name">SMKN 2 Penajam</h4>
    </a>
    ...
    <ul class="sidebar-main-menu">
        ...
        <li class="nav-item ">
            <a class="nav-link " aria-current="page" href="crypto.html">
                ...
                <span class="item-name">Lowongan Pekerjaan</span>
            </a>
        </li>
