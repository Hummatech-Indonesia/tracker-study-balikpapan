        ...
        <div class="relative">
            ...
            <div class="flex">
                <div class="flex items-center xl:hidden gap-2 display-none">
                    ...
                    <a href="../dashboard/index.html" class="flex items-center whitespace-nowrap gap-4">
                        <!--Logo start-->
                    ...
                    <ul class="iq-nav-menu header-menu w-full lg:w-auto list-unstyled ml-2 rtl:mr-2 rtl:ml-0">
                        ...
                        <li class="nav-item">
                            <a class="nav-link menu-arrow justify-start text-secondary-600"
                                ...
                                <span class="nav-text ml-2 rtl:ml-0 rtl:mr-2">Lowongan Pekerjaan</span>
                            </a>
                            <ul class="iq-header-sub-menu list-unstyled" id="allPagesData">
                                ...
                                <li class="nav-item">
                                    ...
                                    <ul class="iq-header-sub-menu left list-unstyled" id="authSkins">
                                        ...
                                        <li class="nav-item"><a class="nav-link "
                                                href="../dashboard/auth/confirm-mail.html">Email Verified</a>
                                        </li>
                                        <li class="nav-item"><a class="nav-link "
                                        ...
                                        <li class="nav-item"><a class="nav-link "
                                                href="../dashboard/auth/two-factors.html">Two Factors</a></li>
                                        <li class="nav-item"><a class="nav-link "
                                                href="../dashboard/auth/deactivate.html">Account Deactivate</a>
                                        </li>
                                    </ul>
                                </li>
                                <li class="nav-item">
                                ...
                                <li class="nav-item">
                                    ...
                                    <ul class="iq-header-sub-menu left list-unstyled" id="extraPlugins">
                                        <li class="nav-item"><a class="nav-link "
                                                href="../dashboard/plugins/button-hover.html">Button Hover</a>
                                        </li>
                                        <li class="nav-item"><a class="nav-link "
                                        ...
                                        <li class="nav-item"><a class="nav-link "
                                                href="../dashboard/plugins/gallery-hover.html">Gallery Hover</a>
                                        </li>
                                        <li class="nav-item"><a class="nav-link "
                        ...
                        <li class="nav-item">
                            <a class="nav-link menu-arrow justify-start text-secondary-600"
                                ...
                                <span class="nav-text ml-2 rtl:ml-0 rtl:mr-2">Alumni </span>
                            </a>
                            <ul class="iq-header-sub-menu list-unstyled" id="elementsData">
                                <li class="nav-item">
                                    ...
                                    <ul class="iq-header-sub-menu left list-unstyled" id="widgetsPage">
                                        <li class="nav-item"><a class="nav-link "
                                                href="../dashboard/ui-elements/alerts.html">Alert</a></li>
                                        <li class="nav-item"><a class="nav-link "
                                                href="../dashboard/ui-elements/badges.html">Badges</a></li>
                                        <li class="nav-item"><a class="nav-link "
                                                href="../dashboard/ui-elements/offcanvas.html">Offcanvas</a>
                                        </li>
                                        <li class="nav-item"><a class="nav-link "
                                                href="../dashboard/ui-elements/notification.html">Notification</a>
                                        </li>
                                        <li class="nav-item"><a class="nav-link "
                                                href="../dashboard/ui-elements/list-group.html">List group</a>
                                        </li>
                                        <li class="nav-item"><a class="nav-link "
                                                href="../dashboard/ui-elements/card.html">Card</a></li>
                                        <li class="nav-item"><a class="nav-link "
                                                href="../dashboard/ui-elements/video.html">Video</a></li>
                                        <li class="nav-item"><a class="nav-link "
                                                href="../dashboard/ui-elements/buttons-group.html">Button
                                                Group</a>
                                        </li>
                                        <li class="nav-item"><a class="nav-link "
                                                href="../dashboard/ui-elements/breadcrumb.html">Breadcrumb</a>
                                        </li>
                                        <li class="nav-item"><a class="nav-link "
                                                href="../dashboard/ui-elements/buttons.html">Buttons</a></li>
                                        <li class="nav-item"><a class="nav-link "
                                                href="../dashboard/ui-elements/pagination.html">Pagination</a>
                                        </li>
                                        <li class="nav-item"><a class="nav-link "
                                                href="../dashboard/ui-elements/popovers.html">Popovers</a></li>
                                        <li class="nav-item"><a class="nav-link "
                                                href="../dashboard/ui-elements/tabpans.html">Tabpans</a></li>
                                        <li class="nav-item"><a class="nav-link "
                                                href="../dashboard/ui-elements/tooltips.html">Tooltips</a></li>
                                    </ul>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link menu-arrow" href="#widgetsPage"
                                ...
                                <li class="nav-item">
                                    ...
                                    <ul class="iq-header-sub-menu left list-unstyled" id="mapPages">
                                        <li class="nav-item"><a class="nav-link "
                                                href="../dashboard/map/google.html">Google</a></li>
                                        <li class="nav-item"><a class="nav-link "
                                                href="../dashboard/map/vector.html">Vector</a></li>
                                    </ul>
                                </li>
                                <li class="nav-item">
                                ...
                                <li class="nav-item">
                                    ...
                                    <ul class="iq-header-sub-menu left list-unstyled" id="tablesPages">
                                        <li class="nav-item"><a class="nav-link "
                                                href="../dashboard/table/data-table.html">Tailwind Table</a>
                                        </li>
                                        <li class="nav-item"><a class="nav-link "
                                                href="../dashboard/table/bordered-table.html">Data Table</a>
                                        </li>
                                        <li class="nav-item"><a class="nav-link "
                                ...
                                <li class="nav-item">
                                    ...
                                    <ul class="iq-header-sub-menu left list-unstyled" id="iconsPages">
                                        <li class="nav-item"><a class="nav-link "
                                                href="../dashboard/icon/solid.html">Solid</a></li>
                                        <li class="nav-item"><a class="nav-link "
                                                href="../dashboard/icon/outlined.html">Outlined</a></li>
                                        <li class="nav-item"><a class="nav-link "
                                                href="../dashboard/icon/dual-tone.html">Dual Tone</a></li>
                                    </ul>
                                </li>
                            </ul>
                        </li>
                ...
                <div class="hidden lg:flex lg:flex-grow transition-all duration-700 ease-in-out">
                    <ul class="flex items-center mb-2 ml-auto rtl:ml-0 rtl:mr-auto lg:mb-0">
                                    ...
                                    <div>
                                        <a href="#"
                                            ...
                                            <div class="flex items-center">
                                                ...
                                                <div class="ml-3 rtl:ml-0 rtl:mr-3 LR">
                                                    <h5 class="mb-0  text-secondary-600 text-lg">Paige Turner
                                                    </h5>
                                                    <small
                                        ...
                                        <a href="#"
                                            ...
                                            <div class="flex items-center">
                                                ...
                                                <div class="ml-3 rtl:ml-0 rtl:mr-3 LR">
                                                    <h5 class="mb-0  text-secondary-600 text-lg">Monty Carlo
                                                    </h5>
                                                    <small
                                        ...
                                        <a href="#"
                                            ...
                                            <div class="flex items-center">
                                                ...
                                                <div class="ml-3 rtl:ml-0 rtl:mr-3 LR">
                                                    <h5 class="mb-0  text-secondary-600 text-lg">Paul Molive
                                                    </h5>
                                                    <small
                                        ...
                                        <a href="#"
                                            ...
                                            <div class="flex items-center">
                                                ...
                                                <div class="ml-3 rtl:ml-0 rtl:mr-3 LR">
                                                    <h5 class="mb-0  text-lg text-secondary-600">Monty Carlo
                                                    </h5>
                                                    <small
                                                        class="text-lg text-secondary-600 dark:text-secondary-600">Carlo.m</small>
                                                </div>
                        ...
                        <li class="flex items-center pl-2" x-data="{ open: false }">
                            ...
                            <div x-show="open" class="absolute z-40 drop-shadow-lg rounded top-14 w-40 "
                                @click.outside="open = false"
                                x-transition:enter="transition ease-in duration-500"
                                x-transition:enter-start="opacity-0 transform translate-y-16"
                                x-transition:enter-end="opacity-100 transform translate-y-0"
                                ...
                                style="display: none;">
                                <div
                                    class="bg-white dark:bg-dark-card shadow-lg rounded p-2 dark:text-secondary-600 ">
                                    <a href="#"
                                        class="flex justify-between w-full py-1 hover:bg-primary-500/[0.1] hover:text-primary-500 hover:rounded hover:ease-in-out duration-300 group">
                                        <input type="radio" value="ltr" class="hidden"
                                            name="theme_scheme_direction" id="ltr"
                                            x-model="setting.theme_scheme_direction">
                                        <label class="flex items-center pl-4" for="ltr">
                                            <div>
                                                <svg width="20" viewBox="0 0 24 24" fill="none"
                                                    xmlns="http://www.w3.org/2000/svg">
                                                    <path
                                    ...
                                    <a href="#"
                                        ...
                                        <input type="radio" value="rtl" class="hidden"
                                            ...
                                            x-model="setting.theme_scheme_direction">
                                        <label class="flex items-center pl-4" for="rtl">
                                            <div>
                                                <svg width="20" viewBox="0 0 24 24" fill="none"
                                                    xmlns="http://www.w3.org/2000/svg">
                                                    <path
                                    ...
                                    <div>
                                        ...
                                        <a href="#"
                                            ...
                                            <div class="flex items-center">
                                                ...
                                                <div class="ml-3 rtl:ml-0 rtl:mr-3 LR">
                                                    <h6 class="mb-0 text-black font-medium">New customer is join
                                                    </h6>
                                                    <small
                                        ...
                                        <a href="#"
                                            ...
                                            <div class="flex items-center">
                                                ...
                                                <div class="ml-3 rtl:ml-0 rtl:mr-3 LR">
                                                    <h6 class="mb-0 text-black font-medium">Two customer is left
                                                    </h6>
                                                    <small
                                                        class="text-sm text-secondary-600 dark:text-secondary-600">Cyst
                                                        Bni</small>
                                        ...
                                        <a href="#"
                                            ...
                                            <div class="flex items-center">
                                                ...
                                                <div class="ml-3 rtl:ml-0 rtl:mr-3 LR">
                                                    <h6 class="mb-0 text-black font-medium">New Mail from Fenny
                                                    </h6>
                                                    <small
                                                        class="text-sm text-secondary-600 dark:text-secondary-600">Cyst
                                                        Bni</small>
                            ...
                            <a class="flex items-center p-2 hover:text-primary-500 focusa text-secondary-600"
                                ...
                                <div class="w-8 rounded-full">
                                    <span class="btn-inner">
                                        ...
                                        <svg class="full-normal-screen icon-24 hidden"
