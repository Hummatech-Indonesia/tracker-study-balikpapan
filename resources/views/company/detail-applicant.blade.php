            ...
            <div class="row">
                <div class="col-12 col-xl-2 col-lg-5">
                    <div class="d-flex justify-content-center">
                        <img src="{{ asset('default.jpg') }}" height="200px" width="200px" style="object-fit: cover" alt="">
                    </div>
                </div>
                ...
                <div class="col-12 col-xl-4 mt-3">
                    <a href="{{ asset('storage/'.$applyJobVacancy->cv) }}" target="_blank" download="CV {{ $applyJobVacancy->student->user->name }}">
